...
class StockGameEngine:
    def __init__(self):
        self.NAME_DB = [
            "한결", "서안", "대승", "해온", "가람", "진성", "세운", "정인", "태림", "선일", "성우", "영진", "경인", "태양", "삼영", "부국", "일성", "청해", "은성", "효성", "넥서스", "이노", "노바", "피닉스", "오로라",
            "제넥스", "퓨어", "솔라", "브릿지", "아이소", "뉴로", "쿼크", "옥타", "이오스", "베가", "시그마", "네오", "루시드", "코어", "플럭스", "다온", "누리", "라온", "마루", "이룸", "새론", "한울", "미리내", "온누리",
            "한빛", "나래", "다솜", "푸름", "슬기", "바른", "든든", "도담", "예그리나", "아리아", "에토스", "벨라", "리베", "로고스", "아인", "노블", "찬영", "지안", "윤성", "하진", "도준", "예준", "건우", "서우",
            "유진", "시우", "이안", "연우", "현승", "무진", "정본", "고조선", "백제", "고구려", "신라", "가야", "발해", "고려", "조선", "헬퍼", "가지", "포도", "복어", "퉁퉁", "기러기", "참새", "백조", "수리", "비둘기",
            "응가", "태백", "청안", "대양", "해람", "단군", "태극", "은하", "성운", "지평", "해오름", "청운", "벽산", "남산", "대안", "평화", "통일", "웅비", "비상", "천명", "명성", "수호", "대덕", "유성", "광원",
            "신뢰", "창조", "진흥", "성신", "보성", "다산", "우신", "대동", "진명", "우주", "영원", "불멸", "상생", "도약", "정수", "이루", "다움", "늘봄", "시작", "뿌리", "줄기", "열매", "흐름", "결실", "마중",
            "디딤", "울림", "바람", "여울", "마음", "솔솔", "아사달", "사비", "웅진", "무령", "광개토", "장수", "을지", "충무", "다보", "석가", "경회", "근정", "화랑", "거북", "해학", "풍류", "단비", "가랑", "윤슬",
            "아라", "자라", "고래", "풍선", "진양", "동승", "세양", "한영", "리안", "수박", "망고", "미르", "새벽", "나무", "감자", "고구마", "코알라", "우성", "경성", "창해", "동우", "태평", "성진", "명인", "한성", "대진",
            "푸딩", "단추", "고무", "양파", "두부", "참깨", "딱지", "도토리", "루멘", "아토", "오빗", "테라", "아크", "모멘트", "다람쥐", "두루미", "상어", "호랑", "민들레", "타이거", "알타이르", "에테르", "시나르", "노릭", "벨로스",
            "아이기스", "오리온", "루모스", "코어텍", "네오스", "인피니", "퀀텀", "솔리드", "에이펙스", "센트럴", "코뿔소", "두더지", "꿀벌", "망치", "구름", "번개", "먼지", "알밤", "붕어빵", "호떡", "까치", "고양이", "강아지", "곰돌이",
            "장화", "우산", "천하", "일송", "대명", "상록", "지성", "청산", "백운", "금강", "단풍", "이슬", "버들", "산들", "대숲", "철강", "태산", "천지", "건곤", "정진", "보람", "젤리", "티라노", "스테고", "스피노", "브라키", "모사", "해피", "앵그리",
            "미래", "육수", "금붕어", "웅이", "유삭", "이래", "법호", "고승", "산호", "현재", "오소리", "벌꿀", "리우스", "두까비", "늑구", "굴", "소풍", "유한", "이두", "삼두", "변율", "태안", "신성", "영풍", "세안", "해찬", "새늘", "아바", "플로",
            "호두", "앵무", "구슬", "우럭", "탐라", "파보", "디키", "모노로", "제플", "아토닉", "곰스오", "스타", "벼룩", "방울", "레온", "몽키", "호박", "해파리", "귤", "스프라이트", "티아라", "크샤트리라","뱀눈", "MALICE", "라이제올", "드래곤 테일", "야미", "K9",
            "뱅키시", "리시드", "현람", "펭귄", "물개", "하마", "코끼리", "표범", "퓨마", "치타", "사자", "고라니", "노루", "아이언", "브론즈", "실버", "골드", "플레", "에메", "다이아", "마스터", "K", "도마", "변기", "수성", "금성", "지구", "화성", "목성",
            "토성", "천왕성", "해왕성", "명왕성", "넥세논", "반티지", "에테리스", "데이터라이즈", "코어닉스", "제노플로우", "시냅틱스", "벨로시티", "제노버스", "퓨레틱", "리보니움", "옵티케어", "바이오닉스", "셀리드", "메디코어", "에이치바이오", "에코플로우",
            "솔레인","아이로닉스", "테라폼", "하이젠", "에너테크", "그리드원", "퓨처엠", "아르카", "프라임에셋", "옴니캐피탈", "큐브홀딩스", "센트럴글로벌", "유니온네트웍스", "비전인베스트", "효승", "가놈", "유화", "삼광", "태화", "금양", "백산", "동남", "동양",
            "한창", "동성", "신일", "경남", "삼화", "대영", "성보", "한일", "대신", "한보","탈모", "에너스", "네오텍", "셀리온", "퓨처원", "에코시스", "아이온", "그린텍", "볼트닉스", "에이치엠", "엔솔", "넥스트라", "모빌리언", "리드", "골드만", "퍼스트",
            "커넥트", "데이터큐브", "플레이온", "하이퍼", "마인드", "링크소프트", "비트원", "클라우드나인", "픽셀트리", "스마트온", "디지털로", "밸류원", "트러스트", "에셋파이브", "크레딧", "참맛", "미디어", "올리브",
    ...
    def announce_earnings(self, s):
        """[v41.0] 현실적 실적 엔진: 체급/연령/기술 격차 통합 (날짜 에러 수정 버전)"""
        from datetime import datetime  # 함수 내 사용을 위해 확인
        
        meta = s['meta']
        name = meta['c_name']
        year = str(self.current_date.year)
        month = self.current_date.month
        quarter = {3: "1분기", 6: "2분기", 9: "3분기", 12: "4분기"}.get(month, "수시")

        # 1. 기초 데이터 (연령/체급) 및 날짜 객체 검증
        ld = meta.get('listed_date_dt')
        
        # [핵심 수정 부분] 데이터가 없거나 문자열(str)인 경우 객체로 변환
        ...
        # 이제 날짜 연산 시 TypeError가 발생하지 않습니다.
        ...
        ipo_penalty = 0.025 if age_days < 1095 else 0.0 # 상장 3년 보호막용 데이터
        
        # 기술 도태 패널티 (Lv.1 유지 시 마진 하락)
        tech_penalty = 0.0
        if getattr(self, 'max_tech_reached', 1) > 1:
            t1_subs = getattr(self, 'INDUSTRY_LEVELS', {}).get(meta['ind'], {}).get(1, [])
            if meta['sub'] in t1_subs:
                tech_penalty = 0.03

        # 3. 영업이익 및 순이익
        # 체급별 기본 마진 보너스 (대기업은 +2%, 소형주는 -1% 등)
        tier_bonus = {"대형주": 0.02, "중형주": 0.00, "소형주": -0.01}.get(tier, 0)

        # 실적 계산 (여기에 기술 도태 패널티와 체급 보너스 합산)
        ...
        # 5. DB 기록
        if name not in self.earnings_history: self.earnings_history[name] = {}
        if year not in self.earnings_history[name]: self.earnings_history[name][year] = {}
        self.earnings_history[name][year][quarter] = {
            "date": self.current_date.strftime("%m월 %d일"),
            "revenue": revenue, "op_income": op_income,
            "net_income": net_income, "is_surplus": net_income > 0
        }
    ...
    def check_delisting(self):
        """[v52.6] 대공황 가드 라인 무력화 및 강제 도산 시스템 (에러 방어 로직 추가)"""
        from datetime import datetime  # 함수 상단에 임포트 확인
        import random
        ...
        for s in candidates:
            if len(delisted_this_turn) >= max_delist: break
            if (len(self.stocks) - len(delisted_this_turn)) <= MIN_STOCKS_LIMIT: break
            
            meta = s['meta']
            
            # [핵심 수정] listed_date_dt가 없거나 '문자열'인 경우 모두 객체로 변환
            ld = meta.get('listed_date_dt')
            if not ld or isinstance(ld, str):
                try:
                    # meta['listed_date']가 "2000-01-01" 형태인 경우를 객체로 변환
                    ld = datetime.strptime(meta['listed_date'], '%Y-%m-%d')
                    meta['listed_date_dt'] = ld
                except (KeyError, ValueError):
                    # 만약 데이터가 아예 없다면 현재 날짜를 기준으로 방어
                    ld = self.current_date
                    meta['listed_date_dt'] = ld

            # 이제 안전하게 날짜 뺄셈이 가능합니다.
            age_days = (self.current_date - ld).days
            ...
            price_guard = 500 if is_depression else 5000
            
            if is_risk_out or is_zombie_out:
                # 가격 방어 로직
                if s['price'] > price_guard:
                    if is_depression and random.random() < 0.3:
                        pass 
                    else:
                        meta['momentum'] = meta.get('momentum', 0) - 0.4
                        meta['risk_score'] = max(0, meta.get('risk_score', 0) - 5)
                        continue 
                
                # --- [수정 포인트: 정보 비대칭 예약] ---
                # 즉시 폐지하지 않고 7일 뒤로 날짜를 확정하여 장부에 기록
                if meta['c_name'] not in self.pending_events["delist"]:
                    # 7일 뒤 날짜 계산
                    delist_date = self.current_date + timedelta(days=7)
                    self.pending_events["delist"][meta['c_name']] = delist_date
                    
                    # (선택) 엔진 내부 로직용 플래그
                    meta['is_doomed'] = True 
                    
                    # 유료 유저는 이 시점에 "찌라시" 뉴스를 볼 수 있게 됨
                    # 일반 뉴스는 7일 뒤 아래의 '상장폐지 결정' 블록이 실행될 때 뜸
                    continue 

                # 장부에 등록된 지 7일이 지났는지 확인
                target_date = self.pending_events["delist"][meta['c_name']]
                if self.current_date < target_date:
                    continue # 아직 7일이 안 지났으면 주가 폭락만 진행 (apply_price_change에서 처리)

                # --- 7일 경과 후: 실제 상장폐지 처리 ---
                reason = "🔥 경제 대공황 파산" if is_depression else ("자본 잠식" if is_risk_out else "연속 적자")
                if not getattr(self, 'silent_mode', False):
                    red_code = getattr(self, 'RED', '')
                    reset_code = getattr(self, 'RESET', '')
                    self.daily_news.append(f"💀 {red_code}[상장폐지] {meta['c_name']}{reset_code} ({reason})")
                
                meta['delisted_date'] = self.current_date.strftime('%Y-%m-%d')
                delisted_this_turn.append(s)
                # 장부에서 제거
                del self.pending_events["delist"][meta['c_name']]
    ...
    def next_day(self, silent=False):
        ...
        # --- [분기점 A: 장이 열린 평일인 경우만 경제 연산 및 '기록' 수행] ---
        if self.is_market_open:
            current_month = self.current_date.month
            current_year_str = str(self.current_date.year)
            cur_day = self.current_date.day

            # 3. [경제 엔진 1단계: 실적 발표 시스템]
            if current_month in [2, 5, 8, 11] and cur_day == 1:
                for s in self.stocks:
                    s['meta']['report_day'] = random.randint(1, 28)

            if current_month in [3, 6, 9, 12, 1, 4, 7, 10]:
                if current_month in [3, 4]: target_q = "1분기"
                elif current_month in [6, 7]: target_q = "2분기"
                elif current_month in [9, 10]: target_q = "3분기"
                else: target_q = "4분기"
                
                for s in self.stocks:
                    meta = s['meta']
                    announced = self.earnings_history.get(meta['c_name'], {}).get(current_year_str, {}).get(target_q)
            ...
            for s in self.stocks:
                ...
                if rate > 0:
                    meta['foreign_share'] = max(0.001, min(0.99, meta['foreign_share'] * (1.0 + rate * 0.3)))
                    meta['inst_share'] = max(0.001, min(0.99, meta['inst_share'] * (1.0 + rate * 0.2)))
                    meta['retail_share'] = max(0.001, min(0.99, meta['retail_share'] * (1.0 + rate * 0.1)))
                else:
                    meta['foreign_share'] = max(0.001, min(0.99, meta['foreign_share'] * (1.0 + rate * 0.8)))
                    meta['inst_share'] = max(0.001, min(0.99, meta['inst_share'] * (1.0 + rate * 0.6)))
                    meta['retail_share'] = max(0.001, min(0.99, meta['retail_share'] * (1.0 + rate * 0.4)))
                
                # 지분율 정규화 (대주주와 자사주는 그대로 유지하고 나머지 비율 조정)
                fixed_shares = meta.get('treasury_share', 0.0) + meta.get('owner_share', 0.0)
                remaining_shares = max(0.0, 1.0 - fixed_shares)
            ...
            # 6. [경제 엔진 3단계: 도태 및 분기점]
            self.check_delisting()
            
            if self.world_line == "Normal" and self.current_date.year >= 2050:
                if random.random() < 0.004 or self.current_date.year >= 2060:
                    if hasattr(self, 'reserved_scenario') and self.reserved_scenario:
                        self.current_scenario = self.reserved_scenario
                    self.world_line = "Decided"
                    if not silent: print(f"🌀 [운명의 날] {self.current_scenario} 결정")
